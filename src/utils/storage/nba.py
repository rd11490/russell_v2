...
team_box_score_traditional = Table(
    ...
    meta,
    primary_varchar_column('GAME_ID', 20),
    primary_varchar_column('TEAM_ID', 20),
    text_column('TEAM_ABBREVIATION'),
    text_column('TEAM_CITY'),
    text_column('MIN'),
    text_column('TEAM_NAME'),
    text_column('WL'),
    text_column('GAME_DATE'),
    text_column('MATCHUP'),
    int_column('FGM'),
    int_column('FGA'),
    float_column('FG_PCT'),
    ...
    int_column('PF'),
    int_column('PTS'),
    int_column('PLUS_MINUS'),
    primary_varchar_column('SEASON', 20),
    primary_varchar_column('SEASON_TYPE', 20))

team_box_score_advanced = Table(
    'team_box_score_advanced',
    meta,
    primary_varchar_column('GAME_ID', 255),
    primary_varchar_column('TEAM_ID', 255),
    text_column('TEAM_NAME'),
    text_column('TEAM_ABBREVIATION'),
    text_column('TEAM_CITY'),
    text_column('MIN'),
    float_column('E_OFF_RATING'),
    float_column('OFF_RATING'),
    float_column('E_DEF_RATING'),
    float_column('DEF_RATING'),
    float_column('E_NET_RATING'),
    float_column('NET_RATING'),
    float_column('AST_PCT'),
    float_column('AST_TOV'),
    float_column('AST_RATIO'),
    float_column('OREB_PCT'),
    float_column('DREB_PCT'),
    float_column('REB_PCT'),
    float_column('E_TM_TOV_PCT'),
    float_column('TM_TOV_PCT'),
    float_column('EFG_PCT'),
    float_column('TS_PCT'),
    float_column('USG_PCT'),
    float_column('E_USG_PCT'),
    float_column('E_PACE'),
    float_column('PACE'),
    float_column('PACE_PER40'),
    float_column('POSS'),
    float_column('PIE'),
    primary_varchar_column('SEASON', 20),
    primary_varchar_column('SEASON_TYPE', 20)
...
player_box_score_traditional = Table(
    ...
    text_column('GAME_DATE'),
    text_column('MATCHUP'),
    primary_varchar_column('PLAYER_ID', 20),
    text_column('PLAYER_NAME'),
    text_column('START_POSITION'),
    text_column('COMMENT'),
    text_column('MIN'),
    int_column('FGM'),
    int_column('FGA'),
...
defensive_matchups_table = Table(
    'defensive_matchups',
    meta,
    primary_varchar_column("OFF_PLAYER_ID", chars=20),
    text_column("OFF_PLAYER_NAME"),
    primary_varchar_column("DEF_PLAYER_ID", chars=20),
    text_column("DEF_PLAYER_NAME"),
    text_column("SEASON_ID"),
    int_column("GP"),
    text_column("MATCHUP_MIN"),
    float_column("PARTIAL_POSS"),
    int_column("PLAYER_PTS"),
    int_column("TEAM_PTS"),
    int_column("MATCHUP_AST"),
    int_column("MATCHUP_TOV"),
    int_column("MATCHUP_BLK"),
    int_column("MATCHUP_FGM"),
    int_column("MATCHUP_FGA"),
    float_column("MATCHUP_FG_PCT"),
    int_column("MATCHUP_FG3M"),
    int_column("MATCHUP_FG3A"),
    float_column("MATCHUP_FG3_PCT"),
    int_column("HELP_BLK"),
    int_column("HELP_FGM"),
    int_column("HELP_FGA"),
    float_column("HELP_FG_PERC"),
    int_column("MATCHUP_FTM"),
    int_column("MATCHUP_FTA"),
    int_column("SFL"),
    primary_varchar_column("SEASON", chars=20),
    primary_varchar_column("SEASON_TYPE"),
)